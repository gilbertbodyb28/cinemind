  ...
  const generate = async () => {
    ...
    try {
      ...
      const msg = provider === "demo"
        ? "Demo profile ready — start Ollama with qwen3:14b for a personalized analysis"
          ...
          <div className="space-y-6">
            ...
            {profile.used_demo && (
              <div className="glass rounded-2xl p-4 border-amber-500/30">
                <div className="text-xs text-amber-300">Demo profile · Start Ollama with qwen3:14b for a personalized analysis.</div>
              </div>
            )}
