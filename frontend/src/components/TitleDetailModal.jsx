...
/**
 * Double-click a queued poster to open this: the YouTube trailer, who is in it
...
export default function TitleDetailModal({ item, onClose }) {
  ...
  return createPortal(
    <div
      ...
      className="fixed inset-0 z-[70] grid place-items-center px-3 py-6 bg-black/75 backdrop-blur-sm"
      onMouseDown={(event) => { if (event.target === event.currentTarget) onClose?.(); }}
    >
      <div className="glass-shell rounded-[26px] w-full max-w-3xl max-h-[88vh] overflow-y-auto scroll-thin grain">
        ...
        <div className="px-5 sm:px-7 pb-7 -mt-14 relative">
          <div className="flex gap-4 sm:gap-6">
            {item.poster && (
              <span className="poster-frame block w-24 sm:w-32 shrink-0">
              <img
                src={item.poster}
                alt={item.title}
          ...
          <section className="mt-6">
            ...
            {loading ? (
              ...
              <button
                ...
                className="relative w-full aspect-video rounded-2xl overflow-hidden border border-white/10 group"
              >
                <img
          ...
          <section className="mt-6">
            ...
            {loading ? (
              ...
              <div data-testid="title-detail-cast" className="grid grid-cols-3 sm:grid-cols-4 lg:grid-cols-6 gap-3">
